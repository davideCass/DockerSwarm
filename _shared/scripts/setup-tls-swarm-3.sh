...
#copia delle chiavi (chiave e certificato di swarm-3 e il certificato della CA)
...
# esporta due variabili d'ambiente che indicano al demone docker di connettersi usando autenticazione a due vie e il percorso delle chiavi
