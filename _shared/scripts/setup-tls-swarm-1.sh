...
#potrebbe convenire copiare le chiavi da swarm-1 in resources e da lì ogni macchina si prende le sue
#expect -c 'spawn  ssh vagrant@swarm-1 "mkdir -p /home/vagrant/.certs"; expect "frase(yes/no):"; send "yes"; expect "password:"; send "vagrant\r"; interact'
#scp ./ca.pem vagrant@swarm-1:/home/vagrant/.certs/ca.pem
scp /home/asw/_shared/resources/certs/ca.pem /home/vagrant/.certs/ca.pem
#scp ./swarm-1-cert.pem vagrant@swarm-1:/home/vagrant/.certs/cert.pem
scp /home/asw/_shared/resources/certs/swarm-1-cert.pem /home/vagrant/.certs/cert.pem
#scp ./swarm-1-priv-key.pem vagrant@swarm-1:/home/vagrant/.certs/key.pem
