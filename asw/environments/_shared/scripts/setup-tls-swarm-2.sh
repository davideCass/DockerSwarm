...
#potrebbe convenire copiare le chiavi da swarm-2 in resources e da lì ogni macchina si prende le sue
#expect -c 'spawn  ssh vagrant@swarm-2 "mkdir -p /home/vagrant/.certs"; expect "frase(yes/no):"; send "yes"; expect "password:"; send "vagrant\r"; interact'
#scp ./ca.pem vagrant@swarm-2:/home/vagrant/.certs/ca.pem
scp /home/asw/_shared/resources/certs/ca.pem /home/vagrant/.certs/ca.pem
#scp ./swarm-2-cert.pem vagrant@swarm-2:/home/vagrant/.certs/cert.pem
scp /home/asw/_shared/resources/certs/swarm-2-cert.pem /home/vagrant/.certs/cert.pem
#scp ./swarm-2-priv-key.pem vagrant@swarm-2:/home/vagrant/.certs/key.pem
