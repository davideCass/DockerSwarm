...
public class HelloClient {
	...
	/* logger */
	private Logger logger = Logger.getLogger("asw.rmi.hello.client");
	 ...
	 * Il primo parametro potrebbe essere la locazione del registry host.  
	 */
	public static void main(String[] args) {
		/* determina il registry host */
		...
		HelloClient client = new HelloClient(registryHost);
		client.run();
	}

	public HelloClient(String registryHost) {
