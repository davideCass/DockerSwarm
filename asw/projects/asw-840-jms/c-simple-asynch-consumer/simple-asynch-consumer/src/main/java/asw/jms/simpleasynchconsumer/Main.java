...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SimpleMessageProcessor simpleProcessor = new LoggerMessageProcessor(consumerName);
//        SimpleAsynchConsumer asynchConsumer = new SimpleAsynchConsumer(consumerName, destination, connectionFactory, simpleProcessor, maxDelay);
        SimpleAsynchConsumer asynchConsumer = new SimpleAsynchConsumer(consumerName, destinationName, CONNECTION_FACTORY_NAME, simpleProcessor, maxDelay);
