...
public class SimpleAsynchConsumer implements Cancellable, MessageListener {
    ...
    SimpleMessageProcessor simpleProcessor;
    ...
    /** Crea un nuovo SimpleAsynchConsumer, di nome n, per una destinazione destinationName.
     * che inviera' i messaggi ricevuti al message processor mp. */
    public SimpleAsynchConsumer(String n, String destinationName, String connectionFactoryName, SimpleMessageProcessor smp, int maxDelay) {
    ...
    /** Crea un nuovo SimpleAsynchConsumer, di nome n, per una destinazione d.
     * che inviera' i messaggi ricevuti al message processor mp. */
    public SimpleAsynchConsumer(String n, Destination d, ConnectionFactory cf, SimpleMessageProcessor smp, int maxDelay) {
    ...
    public synchronized void onMessage(Message m) {
    	...
    	if (m instanceof TextMessage) {
    		...
    		try {
    			...
    			this.simpleProcessor.processMessage(text);
