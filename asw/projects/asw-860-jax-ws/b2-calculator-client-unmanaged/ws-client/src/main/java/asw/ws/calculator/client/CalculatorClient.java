...
//    	"http://10.11.1.111:8080/asw/ws/CalculatorService?wsdl")
//    private static CalculatorService service;

	private Calculator calculator;

	/* logger */
	private static Logger logger = Logger.getLogger("asw.ws.calculator.client");
	...
	public CalculatorClient() {
		this.calculator = new CalculatorService().getCalculatorPort();
	}
