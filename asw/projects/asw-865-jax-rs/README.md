...
* **c3-product-manager-client-curl** 
  un client *bash*/*CURL* per il servizio REST per la *gestione di prodotti* 
...
(tranne **0-preparazione-server**, **a2-hello-client-curl** e **c3-product-manager-client-curl**, 
...
* sul nodo **glassfish**, nella cartella **a1-hello-service** 
